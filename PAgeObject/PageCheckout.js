class pageCheckout {
    constructor(page) {
        ...
        this.dropdownOption = "xpath=//div[text()='Canada']";
        ...
        this.dropdownProvince = "xpath=//div[@data-field-type='MLA_SUBDIVISION']//input[@class='sD4fPao']";
        this.dropdownProvinceOption = "xpath=//div[text()='Ontario']";
        this.fieldZipCode = "xpath=//input[@aria-label='Zip / Postal code']";
        this.buttonContinueCheckout = "xpath=//span[text()='Continue']";
